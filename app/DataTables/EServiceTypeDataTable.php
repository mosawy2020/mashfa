...
class EServiceTypeDataTable extends DataTable
{
    /**
...
//            })
            ->addColumn('action', 'e_service_types.datatables_actions')
...
//            ],
     ...
     */
    public function query(EServiceType $model)
    {
...
//                ->select('e_services.*');
//        }
        return $model->newQuery()->with("categories")->select("$model->table.*");
    }
