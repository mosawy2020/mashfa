...
class BookingDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('e_service_type.name', function ($booking) {
                return getLinksColumnByRouteName([$booking->e_service_type], 'eServiceTypes.edit', 'id', 'name');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'e_service_type.name',
                'name' => 'e_service_type_name',
