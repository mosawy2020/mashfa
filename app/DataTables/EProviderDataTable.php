...
class EProviderDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            // ->editColumn('award_id', function ($eProvider) {
            //     return $eProvider->awards_id->title;
            // })
            // ->editColumn('experience_id', function ($eProvider) {
            //     return $eProvider->experiences_id->title;
            // })
