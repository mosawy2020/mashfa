...
class Category extends Model implements HasMedia
{
     ...
     **/
    public function eServiceTypes()
    {
        return $this->belongsToMany(EServiceType::class);
    }
    ...
    {
        return $this->belongsToMany(EServiceType::class)->with(["eServices" => function ($q) {
                return $q->where('e_services.featured', '=', true);
            }
            ]
        );
    }
