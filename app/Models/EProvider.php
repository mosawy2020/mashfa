...
class EProvider extends Model implements HasMedia, Castable
{
    ...
    public static $rules = [
        ...
        'award_idss' => 'required|exists:awards,id',
        'experience_idss' => 'required|exists:experiences,id',
        'speciality_id' => 'required_if:provider_type_name,==,Doctor|exists:specialities,id'
];
     ...
     * @return HasMany
     **/
    public function experiences_id()
    {
        return $this->belongsTo(Experience::class, 'experience_id');
    }

    
    public function e_provider_awords()
    {
        return $this->belongsToMany(Award::class , 'e_providers_awards' , 'e_provider_id' ,'award_id' ,'id' ,'id');


    }

    public function e_provider_experiences()
    {
        return $this->belongsToMany(Experience::class , 'e_providers_experiences' , 'e_provider_id' ,'experiences_id' ,'id' ,'id');
