<div class='btn-group btn-group-sm'>
    ...
    @can('categories.destroy') {!! Form::open(['route' => ['PatientMedical.destroy', $id], 'method' => 'delete']) !!} {!! Form::button('<i class="fas fa-trash"></i>', [ 'type' => 'submit', 'class' => 'btn btn-link text-danger', 'onclick' => "return confirm('Are you sure?')" ]) !!} {!! Form::close() !!} @endcan
</div>
