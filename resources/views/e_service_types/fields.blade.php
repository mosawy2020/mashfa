...
{{--        <div class="col-md-9">--}}
{{--            {!! Form::select('e_service_type_id', $Eservicestypes, $typesSelected, ['class' => 'select2 form-control not-required' , 'data-empty'=>trans('lang.e_service_types_placeholder')]) !!}--}}
{{--            <div class="form-text text-muted">{{ trans("lang.e_service_categories_help") }}</div>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--    </div>--}}
{{--    @else--}}
{{--        {!! Form::text('e_provider_id', $static_provider_id,  ['hidden'=>true,'class' => 'form-control datetimepicker-input','placeholder'=>  trans("lang.e_service_duration_placeholder"), 'data-target'=>'.timepicker.duration','data-toggle'=>'datetimepicker','autocomplete'=>'off']) !!}--}}
