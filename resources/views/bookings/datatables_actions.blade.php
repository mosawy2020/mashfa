<div class='btn-group btn-group-sm'>
	 ...
	 @can('booking.upload_file')

    <a data-toggle="tooltip" data-placement="left" title="{{trans('lang.upload_file')}}" href="{{ route('booking.upload_file', $id) }}" class='btn btn-link'>
        <i class="fas fa-upload"></i> </a> @endcan
