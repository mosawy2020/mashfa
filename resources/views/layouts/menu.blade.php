                ...
                @can('documents.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('documents*') ? 'active' : '' }}" href="{!! route('documents.index') !!}">@if($icons)
                                <i class="nav-icon fa fa-file"></i>@endif<p>{{trans('eproviderdocuments::lang.documents_plural')}}</p></a>
                    </li>
                @endcan
            @endif
            @can('galleries.index')
...
@can('speciality.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('speciality*') ? 'active' : '' }}" href="{!! route('speciality.index') !!}">@if($icons)
                <i class="nav-icon fas fa-stethoscope"></i>@endif<p>{{trans('lang.speciality')}}</p></a>
    </li>
@endcan
...
@can('PatientMedical.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('PatientMedical*') ? 'active' : '' }}" href="{!! route('PatientMedical.index') !!}">@if($icons)
                <i class="nav-icon fas fa-laptop-medical"></i>@endif<p>{{trans('patient.patient_main')}}</p></a>
    </li>
@endcan
...
@endcan
@can('eServiceTypes.index')
    <li class="nav-item has-treeview {{ Request::is('eServiceTypes*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('eServiceReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{  Request::is('eServiceTypes*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('eServiceReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-pencil-ruler"></i>@endif
            <p>{{trans('lang.e_service_type_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('eServices.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eServiceTypes*') ? 'active' : '' }}" href="{!! route('eServiceTypes.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list"></i>@endif
                        <p>{{trans('lang.e_service_type_table')}}</p></a>
                </li>
            @endcan
{{--            @can('optionGroups.index')--}}
{{--                <li class="nav-item">--}}
    ...
    @can('subscriptionPackages.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('subscriptionPackages*') ? 'active' : '' }}" href="{!! route('subscriptionPackages.index') !!}">@if($icons)
                    <i class="nav-icon fa fa-th-list"></i>@endif<p>{{trans('subscription::lang.subscription_package_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
        </li>
    @endcan

    @can('eProviderSubscriptions.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('eProviderSubscriptions*') ? 'active' : '' }}" href="{!! route('eProviderSubscriptions.index') !!}">@if($icons)
                    <i class="nav-icon fa fa-address-card"></i>@endif<p>{{trans('subscription::lang.e_provider_subscription_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
        </li>
    @endcan
@endif
...
@can('payments.index')
    <li class="nav-item has-treeview {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('eProviderPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('eProviderPayouts*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/authentication') !!}" class="nav-link {{  Request::is('settings/mobile/authentication*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fas fa-comment-alt"></i> @endif <p>{{trans('lang.app_setting_authentication')}}
                    </p>
                </a>
            </li>
