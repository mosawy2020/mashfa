...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item active">{{trans('lang.e_service_create')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
{{--                <a href="{{ route('eProvider.ShowEserviesProvider' , $eProvider->id) }}"  title="{{trans('lang.show')}}" class='btn btn-info'> {{trans('lang.show')}}--}}
{{--                </a>--}}
            ...
            <div class="repeater">
                <div data-repeater-list="List_Classes">
                    <div data-repeater-item>
                             ...
                             @include("e_providers.eserviesfields")
                        <div style="margin-bottom: 35px; margin-left: 20px">
                            <input class="btn btn-danger"  data-repeater-delete type="button"
                                   value="{{ trans('lang.delete') }}"/>
                        </div>
...
$(document).ready(function () {
        ...
        $('.repeater').repeater({
            ...
            defaultValues: {
                'text-input': 'foo',
                e_provider_id:{{$static_provider_id}},
            },
