...
<!-- Name Field -->
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9 eProviderTypeValue">
            {!! Form::select('e_provider_type_id', $eProviderType, null, ['id' => 'job' , 'class' => 'select2 form-control']) !!}
     ...
     <!-- Users Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('users[]', trans("lang.e_provider_users"),['class' => 'col-md-3 control-label text-md-right mx-1 inputEntity']) !!}
        <div class="col-md-9 inputEntity">
            {!! Form::select('users[]', $user, $usersSelected, ['class' => 'inputEntity select2 form-control' , 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.e_provider_users_help") }}</div>
        </div>
    </div> 

    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('speciality_id', trans("lang.speciality") ,['class' => 'col-md-3 control-label text-md-right mx-1 inputDoctor']) !!}
        <div class="col-md-9 inputDoctor">
            {!! Form::select('speciality_id',$speciality, null ,  ['class' => 'inputDoctor select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.speciality") }}</div>
        </div>
    </div>
...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('award_idss', trans("patient.Aword") ,['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('award_idss[]', $aword, $eProvider_aword->e_provider_awords ?? '' , ['class' => 'select2 form-control' , 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("patient.Aword") }}</div>
        </div>
    </div>
    
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('experience_idss', trans("patient.Experience") ,['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('experience_idss[]', $Experience, $eProvider_aword->e_provider_experiences ?? '', ['class' => 'select2 form-control' , 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("patient.Experience") }}</div>
        </div>
    </div>
...
<script> 
//   peovider Type get value hidden user option Entity & Show option Doctors

        $(document).ready(function () {

            $('#job').on('change', function() {
             var data = $('#job :selected').text();
                    CheckDoctorType(data);
alert(data)
                    $('#job').on("select2:select",function() {
