            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-md-row flex-column-reverse align-items-start card-header-tabs">
                    <div class="d-flex flex-row">
                        <li class="nav-item">
                            <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>{{trans('patient.patient')}}</a>
                        </li>
                        @can('PatientMedical.create')
                            <li class="nav-item">
                                {{-- <a class="nav-link" href="{!! route('PatientMedical.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('patient.patient_create')}} --}}
                                </a>
                            </li>
                        @endcan
                    </div>
